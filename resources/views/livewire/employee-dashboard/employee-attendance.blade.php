						...
						<div class="page-header d-xl-flex d-block">
							...
							<div class="page-rightheader ml-md-auto">
								<div class="d-flex align-items-end flex-wrap my-auto right-content breadcrumb-right">
									...
									<div class="d-lg-flex">
										<div class="btn-list">
											<button  class="btn btn-primary mr-4" data-toggle="modal" data-target="#clockinmodal">Clock In</button>
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="btn-list text-center mt-5">
											<a href="#" class="btn ripple btn-primary disabled">Clock in</a>
...
@section('scripts')
		...
		<!-- INTERNAL Index js-->
		<script src="{{URL::asset('assets/js/employee/emp-attendance.js')}}"></script>
