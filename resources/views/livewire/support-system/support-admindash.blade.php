										...
										<a href="#">
											<div class="card-body">
												<div class="row">
													...
													<div class="col-4">
														<div class="icon1 bg-danger-transparent my-auto  float-right"> <i class="ri-coupon-2-line"></i> </div>
													</div>
												</div>
											</div>
										</a>
									...
									<div class="card">
										<div class="card-header border-0">
											...
											<div class="card-options">
												<div class="dropdown"> <a href="#" class="btn btn-outline-light" data-toggle="dropdown" aria-expanded="false"> Monthly <i class="feather feather-chevron-down"></i> </a>
													...
													<div class="row">
														<div class="col-md-6">
															<div class="d-flex font-weight-semibold">
																<span class="dot-label bg-primary mr-2 my-auto"></span>New Tickets
															</div>
														</div>
														<div class="col-md-6">
															<div class="d-flex font-weight-semibold">
																<span class="dot-label bg-secondary mr-2 my-auto"></span>Closed Tickets
															</div>
														</div>
													</div>
												</div>
								...
								<div class="col-xl-6 col-lg-6 col-md-12">
									<div class="card">
										<div class="card-header border-0">
											...
											<div class="card-options">
												<div class="dropdown"> <a href="#" class="btn btn-outline-light" data-toggle="dropdown" aria-expanded="false"> Last Month <i class="feather feather-chevron-down"></i> </a>
													<ul class="dropdown-menu dropdown-menu-right" role="menu">
...
@section('scripts')
		...
		<script src="{{URL::asset('assets/js/support/support-admindash.js')}}"></script>
