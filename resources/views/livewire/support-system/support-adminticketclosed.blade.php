										...
										<table class="table table-vcenter text-nowrap table-hover supportticket-list border-bottom">
											...
											<tbody>
												<tr>
													<td>#01</td>
													<td>
														<div><a href="{{url('support-adminticketclosedview')}}" class="h5">Sed ut perspiciatis</a><span class="badge badge-success-light ml-2 badge-md">Low</span></div>
													...
													<td>
														<div class="d-flex">
															...
															<ul class="dropdown-menu dropdown-menu-right" role="menu">
																...
																<li><a href="#"><i class="feather feather-refresh-cw mr-2"></i>Re-assign Ticket</a></li>
												...
												<tr>
													<td>#02</td>
													<td>
														<div><a href="{{url('support-adminticketclosedview')}}" class="h5">Excepteur occaecat</a><span class="badge badge-success-light ml-2 badge-md">Low</span></div>
												...
												<tr>
													<td>#03</td>
													<td>
														<div><a href="{{url('support-adminticketclosedview')}}" class="h5">Sample Test1</a><span class="badge badge-danger-light ml-2 badge-md">High</span></div>
												...
												<tr>
													<td>#04</td>
													<td>
														<div><a href="{{url('support-adminticketclosedview')}}" class="h5">Sample Test2</a><span class="badge badge-warning-light ml-2 badge-md">Medium</span></div>
												...
												<tr>
													<td>#05</td>
													<td>
														<div><a href="{{url('support-adminticketclosedview')}}" class="h5">Ut aut reiciendi</a><span class="badge badge-success-light ml-2 badge-md">Low</span></div>
												...
												<tr>
													<td>#06</td>
													<td>
														<div><a href="{{url('support-adminticketclosedview')}}" class="h5">Unde omnis iste natus</a><span class="badge badge-success-light ml-2 badge-md">Low</span></div>
												...
												<tr>
													<td>#07</td>
													<td>
														<div><a href="{{url('support-adminticketclosedview')}}" class="h5">Et harum quidem</a><span class="badge badge-warning-light ml-2 badge-md">Medium</span></div>
												...
												<tr>
													<td>#08</td>
													<td>
														<div><a href="{{url('support-adminticketclosedview')}}" class="h5">Maiores alias aut</a><span class="badge badge-danger-light ml-2 badge-md">High</span></div>
												...
												<tr>
													<td>#09</td>
													<td>
														<div><a href="{{url('support-adminticketclosedview')}}" class="h5">Quis autem vel</a><span class="badge badge-danger-light ml-2 badge-md">High</span></div>
												...
												<tr>
													<td>#10</td>
													<td>
														<div><a href="{{url('support-adminticketclosedview')}}" class="h5">Ut aut reiciendi</a><span class="badge badge-danger-light ml-2 badge-md">High</span></div>
