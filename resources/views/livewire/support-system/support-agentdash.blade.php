								...
								<div class="card-body text-center item-user">
									<div class="profile-pic">
										...
										<a href="#" class="text-dark">
											<h5 class="mt-3 mb-1 font-weight-semibold2">Adam Quinn</h5>
										</a>
												...
												<div class="row">
													<div class="col-8">
														<div class="mt-0 text-left">
															...
															<h3 class="mb-0 mt-1 text-primary fs-25">396</h3>
														</div>
													</div>
													<div class="col-4">
												...
												<div class="row">
													<div class="col-8">
														<div class="mt-0 text-left">
															...
															<h3 class="mb-0 mt-1 text-success fs-25">45</h3>
														</div>
													</div>
													<div class="col-4">
												...
												<div class="row">
													<div class="col-8">
														<div class="mt-0 text-left">
															...
															<h3 class="mb-0 mt-1 text-secondary fs-25">22</h3>
														</div>
													</div>
													<div class="col-4">
									...
									<div class="card">
										<div class="card-header border-0 responsive-header">
											...
											<div class="card-options">
												<div class="btn-list">
													<a href="#" class="btn  btn-outline-light text-dark float-left d-flex my-auto"><span class="dot-label bg-primary mr-2 my-auto"></span>Assigned Ticket</a>
													<a href="#" class="btn  btn-outline-light text-dark float-left d-flex my-auto"><span class="dot-label bg-secondary mr-2 my-auto"></span>Closed Ticket</a>
...
@section('scripts')
		...
		<script src="{{URL::asset('assets/js/support/support-agentdash.js')}}"></script>
