						...
						<div class="row text-white">
							...
							<div class="col col-auto">
								<ol class="breadcrumb text-center">
									...
									<li class="breadcrumb-item active">
										<a href="#" class="text-white">Ticket ClosedView</a>
									</li>
								</ol>
							</div>
						</div>
						...
						<div class="col-xl-4">
							<div class="card">
								...
								<div class="card-footer text-center">
									<a href="#" class="btn btn-light btn-block">View Profile</a>
								</div>
							</div>
							<div class="card">
								<div class="card-header  border-0">
								...
								<div class="card-footer text-center">
									<div class="btn-list">
										...
										<a href="#" class="btn btn-outline-light btn-block">Delete Ticket</a>
									</div>
								</div>
							</div>
							<div class="card">
						...
						<div class="col-xl-8">
							...
							<div class="card reply-card">
								<div class="card-body text-center">
									...
									<label class="mb-0">Do you Want to Re-open?</label><a href="#" class="btn btn-primary btn-sm ml-2 reopen-button">Re-Open</a>
								</div>
							</div>
