				...
				<div class="header-text mb-0">
					<div class="container">
						<div class="row text-white">
							<div class="col">
								<h1 class="mb-0">ClosedTickets</h1>
							</div>
							<div class="col col-auto">
								<ol class="breadcrumb text-center">
									...
									<li class="breadcrumb-item active">
										<a href="#" class="text-white">ClosedTickets</a>
									</li>
								</ol>
							</div>
						</div>
										...
										<table class="table table-vcenter text-nowrap table-hover border-bottom supportticket-active">
											...
											<tbody>
												<tr>
													<td>#289</td>
													<td>
														<div><a href="{{url('support-ticketclosedview')}}" class="h5">Sed ut perspiciatis</a></div>
													...
													<td><span class="fs-13 text-muted"><i class="feather feather-clock mr-2"></i>5 hours ago</span></td>
													<td>
														<div class="d-flex">
												...
												<tr>
													<td>#320</td>
													<td>
														<div><a href="{{url('support-ticketclosedview')}}" class="h5">Excepteur occaecat</a></div>
													...
													<td>Services</td>
													<td><span class="badge badge-danger">Closed</span></td>
													<td><span class="fs-13 text-muted"><i class="feather feather-clock mr-2"></i>12 hours ago</span></td>
													<td>
														<div class="d-flex">
															<a href="#" class="action-btns1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather feather-more-vertical text-primary"></i></a>
															<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												<tr>
													<td>#837</td>
													<td>
														<div><a href="{{url('support-ticketclosedview')}}" class="h5">Sample Test1</a></div>
													...
													<td>Customization</td>
													<td><span class="badge badge-danger">Closed</span></td>
													<td><span class="fs-13 text-muted"><i class="feather feather-clock mr-2"></i>1 week ago</span></td>
													<td>
														<div class="d-flex">
															<a href="#" class="action-btns1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather feather-more-vertical text-primary"></i></a>
															<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												<tr>
													<td>#124</td>
													<td>
														<div><a href="{{url('support-ticketclosedview')}}" class="h5">Sample Test2</a></div>
													...
													<td>Support</td>
													<td><span class="badge badge-danger">Closed</span></td>
													<td><span class="fs-13 text-muted"><i class="feather feather-clock mr-2"></i>3 weeks ago</span></td>
													<td>
														<div class="d-flex">
															<a href="#" class="action-btns1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather feather-more-vertical text-primary"></i></a>
															<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												<tr>
													<td>#309</td>
													<td>
														<div><a href="{{url('support-ticketclosedview')}}" class="h5">Ut aut reiciendi</a></div>
													...
													<td>Services</td>
													<td><span class="badge badge-danger">Closed</span></td>
													<td><span class="fs-13 text-muted"><i class="feather feather-clock mr-2"></i>4 weeks ago</span></td>
													<td>
														<div class="d-flex">
															<a href="#" class="action-btns1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather feather-more-vertical text-primary"></i></a>
															<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												<tr>
													<td>#117</td>
													<td>
														<div><a href="{{url('support-ticketclosedview')}}" class="h5">Unde omnis iste natus</a></div>
													...
													<td>Services</td>
													<td><span class="badge badge-danger">Closed</span></td>
													<td><span class="fs-13 text-muted"><i class="feather feather-clock mr-2"></i>1 month ago</span></td>
													<td>
														<div class="d-flex">
															<a href="#" class="action-btns1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather feather-more-vertical text-primary"></i></a>
															<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												<tr>
													<td>#276</td>
													<td>
														<div><a href="{{url('support-ticketclosedview')}}" class="h5">Et harum quidem</a></div>
													...
													<td>Support</td>
													<td><span class="badge badge-danger">Closed</span></td>
													<td><span class="fs-13 text-muted"><i class="feather feather-clock mr-2"></i>3 months ago</span></td>
													<td>
														<div class="d-flex">
															<a href="#" class="action-btns1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather feather-more-vertical text-primary"></i></a>
															<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												<tr>
													<td>#738</td>
													<td>
														<div><a href="{{url('support-ticketclosedview')}}" class="h5">Maiores alias aut</a></div>
													...
													<td>Services</td>
													<td><span class="badge badge-danger">Closed</span></td>
													<td><span class="fs-13 text-muted"><i class="feather feather-clock mr-2"></i>4 months ago</span></td>
													<td>
														<div class="d-flex">
															<a href="#" class="action-btns1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather feather-more-vertical text-primary"></i></a>
															<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												<tr>
													<td>#498</td>
													<td>
														<div><a href="{{url('support-ticketclosedview')}}" class="h5">Quis autem vel</a></div>
													...
													<td>Support</td>
													<td><span class="badge badge-danger">Closed</span></td>
													<td><span class="fs-13 text-muted"><i class="feather feather-clock mr-2"></i>6 months ago</span></td>
													<td>
														<div class="d-flex">
															<a href="#" class="action-btns1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather feather-more-vertical text-primary"></i></a>
															<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												<tr>
													...
													<td>Services</td>
													<td><span class="badge badge-danger">Closed</span></td>
													<td><span class="fs-13 text-muted"><i class="feather feather-clock mr-2"></i>1 year ago</span></td>
													<td>
														<div class="d-flex">
															<a href="#" class="action-btns1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather feather-more-vertical text-primary"></i></a>
															<ul class="dropdown-menu dropdown-menu-right" role="menu">
...
@section('scripts')
		...
		<script src="{{URL::asset('assets/js/support/support-ticketactive.js')}}"></script>
