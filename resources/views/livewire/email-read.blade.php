									...
									<div class="card-body">
										<div class="email-media">
											<div class="mt-0 d-sm-flex">
												<img class="mr-2 rounded-circle avatar avatar-lg" src="{{URL::asset('assets/images/users/16.jpg')}}" alt="avatar">
												<div class="media-body pt-0">
													<div class="float-right d-none d-md-flex fs-15">
														<small class="mr-3 mt-1 text-muted">Sep 13 , 2021 12:45 pm</small>
														<a class="mr-3" data-toggle="tooltip" title="" data-original-title="Rated"><i class="ri-star-s-line"></i></a>
														<a class="mr-3" data-toggle="tooltip" title="" data-original-title="Reply"><i class="fa fa-reply"></i></a>
														<div class="mr-3">
															<a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="ri-more-fill"></i></a>
													...
													<small class="mr-2 d-md-none">Dec 13 , 2021 12:45 pm</small>
												</div>
											</div>
										</div>
