						...
						<div class="row">
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button  class="btn btn-dark"><i class="fe fe-upload mr-2"></i>Upload</button>
											<button  class="btn btn-warning"><i class="fe fe-heart mr-2"></i>I like</button>
											<button  class="btn btn-success"><i class="fe fe-check mr-2"></i>I agree</button>
											<button  class="btn btn-primary"><i class="fe fe-plus mr-2"></i>More</button>
											<button  class="btn btn-danger"><i class="fe fe-link mr-2"></i>Link</button>
											<button  class="btn btn-info"><i class="fe fe-message-circle mr-2"></i>Comment</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12 col-lg-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button  class="btn btn-dark">Upload <i class="fa fa-upload fa-spin ml-2"></i></button>
											<button  class="btn btn-warning">I like <i class="fa fa-heart fa-spin ml-2"></i></button>
											<button  class="btn btn-success">I agree <i class="fa fa-check fa-spin ml-2"></i></button>
											<button  class="btn btn-primary">More <i class="fa fa-plus fa-spin ml-2"></i></button>
											<button  class="btn btn-danger">Link <i class="fa fa-link fa-spin ml-2"></i></button>
											<button  class="btn btn-info">Comment <i class="fa fa-comment-o fa-spin ml-2"></i></button>
										</div>
									</div>
								</div>
							</div>
						...
						<div  class="row">
							<div class="col-md-12 ">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button  class="btn btn-warning btn-sm mb-1">Small button</button>
											<button  class="btn btn-info  mb-1">Medium button</button>
											<button  class="btn btn-success btn-lg mb-1">Large button</button>
							...
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button  class="btn btn-facebook"><i class="fa fa-facebook mr-2"></i>Facebook</button>
											<button  class="btn btn-twitter"><i class="fa fa-twitter mr-2"></i>Twitter</button>
											<button  class="btn btn-google"><i class="fa fa-google mr-2"></i>Google</button>
											<button  class="btn btn-youtube"><i class="fa fa-youtube mr-2"></i>Youtube</button>
											<button  class="btn btn-vimeo"><i class="fa fa-vimeo mr-2"></i>Vimeo</button>
											<button  class="btn btn-dribbble"><i class="fa fa-dribbble mr-2"></i>Dribble</button>
											<button  class="btn btn-github"><i class="fa fa-github mr-2"></i>Github</button>
											<button  class="btn btn-instagram"><i class="fa fa-instagram mr-2"></i>Instagram</button>
											<button  class="btn btn-pinterest"><i class="fa fa-pinterest mr-2"></i>Pinterest</button>
											<button  class="btn btn-vk"><i class="fa fa-vk mr-2"></i>VKontakte</button>
											<button  class="btn btn-rss"><i class="fa fa-rss mr-2"></i>RSS</button>
											<button  class="btn btn-flickr"><i class="fa fa-flickr mr-2"></i>Flickr</button>
										</div>
									</div>
								</div>
							</div>
						...
						<div  class="row">
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button  class="btn btn-icon btn-facebook"><i class="fa fa-facebook"></i></button>
											<button  class="btn btn-icon btn-twitter"><i class="fa fa-twitter"></i></button>
											<button  class="btn btn-icon btn-google"><i class="fa fa-google"></i></button>
											<button  class="btn btn-icon btn-youtube"><i class="fa fa-youtube"></i></button>
											<button  class="btn btn-icon btn-vimeo"><i class="fa fa-vimeo"></i></button>
											<button  class="btn btn-icon btn-dribbble"><i class="fa fa-dribbble"></i></button>
											<button  class="btn btn-icon btn-github"><i class="fa fa-github"></i></button>
											<button  class="btn btn-icon btn-instagram"><i class="fa fa-instagram"></i></button>
											<button  class="btn btn-icon btn-pinterest"><i class="fa fa-pinterest"></i></button>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button  class="btn btn-icon btn-primary"><i class="fe fe-activity"></i></button>
											<button  class="btn btn-icon btn-primary btn-github"><i class="fe fe-github"></i></button>
											<button  class="btn btn-icon btn-success"><i class="fe fe-bell"></i></button>
											<button  class="btn btn-icon btn-warning"><i class="fe fe-star"></i></button>
											<button  class="btn btn-icon btn-danger"><i class="fe fe-trash"></i></button>
											<button  class="btn btn-icon btn-purple"><i class="fe fe-bar-chart"></i></button>
											<button  class="btn btn-icon btn-secondary"><i class="fe fe-git-merge"></i></button>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-12 col-lg-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button  class="btn btn-dark btn-icon btn-svg"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="100%" viewBox="0 0 24 24" width="100%"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M13 4H6v16h12V9h-5V4zm3 14H8v-2h8v2zm0-6v2H8v-2h8z" opacity=".3"></path><path d="M8 16h8v2H8zm0-4h8v2H8zm6-10H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"></path></svg></button>
											<button  class="btn btn-warning btn-icon btn-svg"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="100%" viewBox="0 0 24 24" width="100%"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M5 19h14V8H5v11zm5.55-6v-3h2.91v3H16l-4 4-4-4h2.55z" opacity=".3"></path><path d="M16 13h-2.55v-3h-2.9v3H8l4 4zm4.54-7.77l-1.39-1.68C18.88 3.21 18.47 3 18 3H6c-.47 0-.88.21-1.16.55L3.46 5.23C3.17 5.57 3 6.02 3 6.5V19c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6.5c0-.48-.17-.93-.46-1.27zM6.24 5h11.52l.81.97H5.44l.8-.97zM19 19H5V8h14v11z"></path></svg></button>
											...
											<button  class="btn btn-primary btn-icon btn-svg"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="100%" viewBox="0 0 24 24" width="100%"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M16.5 5c-1.54 0-3.04.99-3.56 2.36h-1.87C10.54 5.99 9.04 5 7.5 5 5.5 5 4 6.5 4 8.5c0 2.89 3.14 5.74 7.9 10.05l.1.1.1-.1C16.86 14.24 20 11.39 20 8.5c0-2-1.5-3.5-3.5-3.5z" opacity=".3"></path><path d="M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3zm-4.4 15.55l-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05z"></path></svg></button>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="text-wra">
											...
											<div class="example">
												<div class="btn-list">
													<button  class="btn btn-primary btn-loading">Button text</button><br>
													<button  class="btn btn-success btn-loading btn-icon"><i class="fe fe-check"></i></button>
													<button  class="btn btn-warning btn-loading btn-sm">Button text</button><br>
													<button  class="btn btn-danger btn-loading btn-lg">Button text</button>
													<button  class="btn btn-info btn-loading btn-block">Button text</button>
												</div>
											</div>
										</div>
									</div>
