							...
							<div class="col-xl-3">
								<div class="card">
									<div class="nav flex-column admisetting-tabs" id="settings-tab" role="tablist" aria-orientation="vertical">
										...
										<a class="nav-link"  data-toggle="pill" href="#tab-6" role="tab">
											<i class="nav-icon las la-bell"></i> Notification Settings
										</a>
										<a class="nav-link"  data-toggle="pill" href="#tab-7" role="tab">
											<i class="nav-icon las la-envelope"></i> Email Settings
										</a>
										<a class="nav-link"  data-toggle="pill" href="#tab-8" role="tab">
											<i class="nav-icon las la-comment"></i> Chat Settings
										</a>
										<a class="nav-link"  data-toggle="pill" href="#tab-9" role="tab">
