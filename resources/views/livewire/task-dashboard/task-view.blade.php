...
@section('content')
						...
						<div class="page-header d-xl-flex d-block">
							<div class="page-leftheader">
								<h4 class="page-title"><span class="font-weight-normal text-muted mr-2">Task 01</span> Design Updated </h4>
							</div>
							...
							<div class="col-xl-3 col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header  border-0">
										...
										<div class="ml-auto">
											<a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#recurringmodal">Recurring</a>
										</div>
									</div>
									<div class="card-body">
								...
								<div class="tab-menu-heading hremp-tabs p-0 ">
									<div class="tabs-menu1">
										...
										<ul class="nav panel-tabs">
											...
											<li><a href="#tab6"  data-toggle="tab">Sub Task</a></li>
											<li><a href="#tab7" data-toggle="tab">Comment</a></li>
											<li><a href="#tab8" data-toggle="tab">Note</a></li>
											<li><a href="#tab9" data-toggle="tab">Attachment</a></li>
											<li><a href="#tab10" data-toggle="tab">FAQS</a></li>
										</ul>
									</div>
								</div>
									...
									<div class="tab-content">
										<div class="tab-pane active" id="tab5">
											<div class="card-body">
												...
												<div class="main-profile-bio mb-0">
													...
													<p>simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy  when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries nchanged.</p>
													<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
													<p>pleasure rationally encounter but because pursue consequences that are extremely painful.occur in which toil and pain can procure him some great pleasure.. <a href="">More</a></p>
													...
													<div class="row attachments-doc">
														<div class="col-md-12 col-xl-4">
															<div class="list-group-item  align-items-center">
																<div class="d-md-flex">
																	<img src="{{URL::asset('assets/images/files/attachments/2.png')}}" alt="img" class="avatar bg-transparent avatar-xl">
														...
														<div class="col-md-12 col-xl-4 mt-4 mt-xl-0">
															<div class="list-group-item  align-items-center">
																<div class="d-md-flex">
																	<img src="{{URL::asset('assets/images/files/attachments/4.png')}}" alt="img" class="avatar bg-transparent avatar-xl">
														...
														<div class="col-md-12 col-xl-4 mt-4 mt-xl-0">
															<div class="list-group-item  align-items-center">
																<div class="d-md-flex">
																	<img src="{{URL::asset('assets/images/files/attachments/3.png')}}" alt="img" class="avatar bg-transparent avatar-xl">
																	<a href="#" class="font-weight-semibold fs-14 mt-5">files.doc<span class="text-muted ml-2">(2.67 KB)</span></a>
																	<div class="ml-auto d-flex mt-4 text-right">
																		<a href="#" class="action-btns1"><i class="feather feather-download-cloud text-primary"></i></a>
																		<a href="#" class="action-btns1 mr-0"><i class="feather feather-trash-2 text-danger"></i></a>
																	</div>
												...
												<div class="row">
													<div class="col-md-4">
														<div class="card border p-0 shadow-none">
															<div class="card-header border-0">
																<span class="badge badge-md badge-primary-light">Today task</span>
																<div class="ml-auto">
																	<a href="#" class="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																		<i class="feather feather-more-horizontal text-primary fs-18"></i>
																	</a>
															...
															<div class="card-body pt-0">
																...
																<p class="fs-13 text-muted"><i class="feather feather-clock  mr-2"></i>Dead line 6:00 Pm</p>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="card border p-0 shadow-none">
															<div class="card-header border-0">
																<span class="badge badge-md badge-danger-light">Pending task</span>
																<div class="ml-auto">
																	<a href="#" class="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																		<i class="feather feather-more-horizontal text-primary fs-18"></i>
																	</a>
													...
													<div class="col-md-4">
														<div class="card border p-0 shadow-none">
															<div class="card-header border-0">
																<span class="badge badge-md badge-success-light">Completed task</span>
																<div class="ml-auto">
																	<a href="#" class="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																		<i class="feather feather-more-horizontal text-primary fs-18"></i>
																	</a>
															...
															<div class="card-body pt-0">
																...
																<p class="fs-13 text-muted"><i class="feather feather-clock  mr-2"></i>Dec 02 2019</p>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="card-body attachments-doc">
												<div class="row">
													...
													<div class="col-md-12 col-xl-4 mt-4 mt-xl-0">
														<div class="list-group-item  align-items-center">
															<div class="d-md-flex">
																<img src="{{URL::asset('assets/images/files/attachments/4.png')}}" alt="img" class="avatar bg-transparent avatar-xl mr-2">
																<a href="#" class="font-weight-semibold fs-14 mt-5">Project<span class="text-muted ml-2">(578.6MB)</span></a>
																<div class="ml-auto d-flex mt-4 text-right">
																	<a href="#" class="action-btns1"><i class="feather feather-download-cloud text-primary"></i></a>
																	<a href="#" class="action-btns1 mr-0"><i class="feather feather-trash-2 text-danger"></i></a>
													...
													<div class="col-md-12 col-xl-4 mt-4 mt-xl-0">
														<div class="list-group-item  align-items-center">
															<div class="d-md-flex">
																<img src="{{URL::asset('assets/images/products/1.jpg')}}" alt="img" class="avatar bg-transparent avatar-xl mr-2">
												...
												<div class="row mt-5">
													<div class="col-md-12 col-xl-4">
														<div class="list-group-item  align-items-center">
															<div class="d-md-flex">
																<img src="{{URL::asset('assets/images/files/attachments/3.png')}}" alt="img" class="avatar bg-transparent avatar-xl mr-2">
																<a href="#" class="font-weight-semibold fs-14 mt-5">files.doc<span class="text-muted ml-2">(23 KB)</span></a>
																<div class="ml-auto d-flex mt-4 text-right">
																	<a href="#" class="action-btns1"><i class="feather feather-download-cloud text-primary"></i></a>
																	<a href="#" class="action-btns1  mr-0"><i class="feather feather-trash-2 text-danger"></i></a>
																</div>
													...
													<div class="col-md-12 col-xl-4 mt-4 mt-xl-0">
														<div class="list-group-item  align-items-center">
															<div class="d-md-flex">
																<img src="{{URL::asset('assets/images/files/attachments/6.png')}}" alt="img" class="avatar bg-transparent avatar-xl mr-2">
																<a href="#" class="font-weight-semibold fs-14 mt-5">style.css<span class="text-muted ml-2">(176 KB)</span></a>
																<div class="ml-auto d-flex mt-4 text-right">
																	<a href="#" class="action-btns1"><i class="feather feather-download-cloud text-primary"></i></a>
																	<a href="#" class="action-btns1  mr-0"><i class="feather feather-trash-2 text-danger"></i></a>
																</div>
													...
													<div class="col-md-12 col-xl-4 mt-4 mt-xl-0">
														<div class="list-group-item  align-items-center">
															<div class="d-md-flex">
																<img src="{{URL::asset('assets/images/files/attachments/5.png')}}" alt="img" class="avatar bg-transparent avatar-xl mr-2">
																<a href="#" class="font-weight-semibold fs-14 mt-5">index.html<span class="text-muted ml-2">(176 KB)</span></a>
																<div class="ml-auto d-flex mt-4 text-right">
																	<a href="#" class="action-btns1"><i class="feather feather-download-cloud text-primary"></i></a>
																	<a href="#" class="action-btns1  mr-0"><i class="feather feather-trash-2 text-danger"></i></a>
																</div>
												...
												<div class="row mt-5">
													<div class="col-md-12 col-xl-4">
														<div class="list-group-item  align-items-center text-center">
										...
										<div class="tab-pane" id="tab10">
											<div class="card-body">
													...
													<div class="row">
																...
																<div class="acc-header" id="headingOne" role="tab">
																	<h5 class="mb-0">
																		<a aria-controls="collapseOne" aria-expanded="true" data-toggle="collapse" href="#collapseOne">
																			Have you insert form validations Page? <span class="float-right acc-angle"><i class="fe fe-chevron-right"></i></span>
																		</a>
																	</h5>
																</div>
														...
														<div class="col-md-12 col-xl-1">
															<div class="d-flex mt-2 text-right">
																<a href="#" class="action-btns1" data-toggle="tooltip" data-placement="top" title="View"><i class="feather feather-edit-2 text-primary"></i></a>
																...
																<div class="acc-header" id="headingTwo" role="tab">
																	<h5 class="mb-0">
																		<a aria-controls="collapseOne" aria-expanded="true" data-toggle="collapse" href="#collapseTwo">
																			Have you made Responsiveness? <span class="float-right acc-angle"><i class="fe fe-chevron-right"></i></span>
																		</a>
																	</h5>
																</div>
																...
																<div class="acc-header" id="headingThree" role="tab">
																	<h5 class="mb-0">
																		<a aria-controls="collapseOne" aria-expanded="true" data-toggle="collapse" href="#collapseThree">
																			Have you using Bootstrap?<span class="float-right acc-angle"><i class="fe fe-chevron-right"></i></span>
																		</a>
																	</h5>
																</div>
																...
																<div class="acc-header" id="headingfour" role="tab">
																	<h5 class="mb-0">
																		<a aria-controls="collapseOne" aria-expanded="true" data-toggle="collapse" href="#collapsefour">
																			Have you insert live chat? <span class="float-right acc-angle"><i class="fe fe-chevron-right"></i></span>
																		</a>
																	</h5>
																</div>
												...
												<div class="mt-5">
													<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#addfaqmodal"><i class="feather feather-plus fs-15 my-auto mr-2"></i>Add Faq</a>
												</div>
											</div>
										</div>
									</div>
...
@section('modals')
			...
			<div class="modal fade"  id="recurringmodal">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">Recurring</h5>
							<button  class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">×</span>
							</button>
						</div>
						...
						<div class="modal-footer">
							...
							<a href="#" class="btn btn-primary" onclick="not1()">Submit</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal fade"  id="addfaqmodal">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">Ask FAQS</h5>
							<button  class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">×</span>
							</button>
						</div>
						<div class="modal-body">
							<div class="form-group">
								<input type="text" class="form-control" id="name1" placeholder="enter Faq">
							</div>
							<div class="form-group">
								<textarea class="form-control" name="example-textarea-input" rows="6" placeholder="description"></textarea>
							</div>
						</div>
						<div class="modal-footer">
							<a href="#" class="btn btn-outline-danger" data-dismiss="modal">Close</a>
