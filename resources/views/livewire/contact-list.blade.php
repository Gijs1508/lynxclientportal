													...
													<div class="col-xl-4 col-lg-6">
														<div class="card text-center user-contact-list">
															<div class="p-5">
																...
																<div class="mt-5">
																	<a class="btn btn-white" href="#"><span class="feather feather-message-square fs-15 mr-1 my-auto"></span> Message</a>
																	<a class="btn btn-light" href="#"><span class="feather feather-user fs-15 mr-1 my-auto"></span>Profile</a>
																</div>
															</div>
														</div>
													</div>
