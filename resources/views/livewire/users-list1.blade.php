...
@section('content')
						...
						<div class="page-header d-lg-flex d-block">
							<div class="page-leftheader">
								<h4 class="page-title">User-List 01</h4>
							</div>
															...
															<tbody>
																<tr>
																	...
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">30%</h6></div>
																	...
																	<td class="align-middle">
																		<div class="btn-group align-top">
																			...
																			<button class="btn btn-sm btn-white" ><span class="feather feather-trash-2 text-muted fs-16"></span></button>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">82%</h6></div>
																		<div class="progress progress-sm mb-0 mt-1">
																...
																<tr>
																	...
																	<td class="text-nowrap align-middle"><span>09 Dec 2017</span></td>
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">68%</h6></div>
																		<div class="progress progress-sm mb-0 mt-1">
																...
																<tr>
																	...
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">78%</h6></div>
																		<div class="progress progress-sm mb-0 mt-1">
																...
																<tr>
																	...
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">45%</h6></div>
																		<div class="progress progress-sm mb-0 mt-1">
																...
																<tr>
																	...
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">60%</h6></div>
																		<div class="progress progress-sm mb-0 mt-1">
																...
																<tr>
																	...
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">55%</h6></div>
																		<div class="progress progress-sm mb-0 mt-1">
																...
																<tr>
																	...
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">40%</h6></div>
																		<div class="progress progress-sm mb-0 mt-1">
																...
																<tr>
																	...
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">80%</h6></div>
																		<div class="progress progress-sm mb-0 mt-1">
																...
																<tr>
																	...
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">70%</h6></div>
																		<div class="progress progress-sm mb-0 mt-1">
																...
																<tr>
																	...
																	<td class="text-nowrap align-middle"><span>09 Dec 2017</span></td>
																	<td class="text-nowrap align-middle">
																		<div class="float-right"><h6 class="mb-2 ml-4 font-weight-semibold">65%</h6></div>
																		<div class="progress progress-sm mb-0 mt-1">
