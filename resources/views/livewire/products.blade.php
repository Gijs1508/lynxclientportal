							...
							<div class="col-xl-3">
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="mt-3">
											...
											<div class="form-group">
												...
												<select class="form-control custom-select select2" data-placeholder="Select Type">
										...
										<div class="mt-3">
											...
											<div class="custom-controls-stacked">
												<label class="custom-control custom-radio">
													...
													<span class="custom-control-label">$100 to $500</span>
												</label>
											</div>
											<div class="custom-controls-stacked">
												<label class="custom-control custom-radio">
									...
									<div class="card-footer">
										<a class="btn btn-primary btn-block" href="#">Apply Filter</a>
									</div>
								</div>
							</div>
							<div class="col-xl-9">
										...
										<div class="card item-card overflow-hidden">
											<div class="item-image">
												...
												<ul class="product-links">
													<li>
														<a class="product-links-icon" href="#"><i class="fa fa-heart text-danger"></i></a>
													</li>
													<li>
														<a class="product-links-icon" href="#"><i class="fa fa-shopping-cart"></i></a>
													</li>
												</ul>
												<div class="product-overly">
													<a href="#" class="text-white"><i class="fa fa-eye mr-1"></i><span>Quick View</span></a>
												</div>
											</div>
											<div class="card-body text-center">
												...
												<div class="mb-1 fs-13 mt-2">
													...
													<a href="#"><i class="fa fa-star text-yellow"></i></a>
													<a href="#"><i class="fa fa-star text-yellow"></i></a>
													<a href="#"><i class="fa fa-star-half-o text-yellow"></i></a>
													<a href="#"><i class="fa fa-star-o text-yellow"></i></a>
													<a href="#" class="text-muted fs-13"> (48)</a>
												</div>
												<div class="cardprice">
										...
										<div class="card item-card overflow-hidden">
											...
											<div class="card-body text-center">
												...
												<div class="mb-1 fs-13 mt-2">
													...
													<a href="#"><i class="fa fa-star-half-o text-yellow"></i></a>
													<a href="#"><i class="fa fa-star-o text-yellow"></i></a>
													<a href="#" class="text-muted fs-13"> (18)</a>
												</div>
												<div class="cardprice">
									...
									<div class="col-xl-4 col-md-12">
										<div class="card item-card overflow-hidden">
											<div class="item-image">
												...
												<ul class="product-links">
													<li>
														<a class="product-links-icon" href="#"><i class="fa fa-heart-o text-danger"></i></a>
													</li>
													<li>
														<a class="product-links-icon" href="#"><i class="fa fa-shopping-cart"></i></a>
													</li>
											...
											<div class="card-body text-center">
												...
												<div class="mb-1 fs-13 mt-2">
													...
													<a href="#"><i class="fa fa-star-half-o text-yellow"></i></a>
													<a href="#"><i class="fa fa-star-o text-yellow"></i></a>
													<a href="#" class="text-muted fs-13"> (12)</a>
												</div>
												<div class="cardprice">
										...
										<div class="card item-card overflow-hidden">
											...
											<div class="card-body text-center">
												...
												<div class="mb-1 fs-13 mt-2">
													...
													<a href="#"><i class="fa fa-star-o text-yellow"></i></a>
													<a href="#"><i class="fa fa-star-o text-yellow"></i></a>
													<a href="#" class="text-muted fs-13"> (02)</a>
												</div>
												<div class="cardprice">
										...
										<div class="card item-card overflow-hidden">
											...
											<div class="card-body text-center">
												...
												<div class="mb-1 fs-13 mt-2">
													...
													<a href="#"><i class="fa fa-star-o text-yellow"></i></a>
													<a href="#"><i class="fa fa-star-o text-yellow"></i></a>
													<a href="#" class="text-muted fs-13"> (06)</a>
												</div>
												<div class="cardprice">
										...
										<div class="card item-card overflow-hidden">
											...
											<div class="card-body text-center">
												...
												<div class="mb-1 fs-13 mt-2">
													...
													<a href="#"><i class="fa fa-star-half-o text-yellow"></i></a>
													<a href="#"><i class="fa fa-star-o text-yellow"></i></a>
													<a href="#" class="text-muted fs-13"> (16)</a>
												</div>
												<div class="cardprice">
													<span class="type--strikethrough">$450</span>
													<span>$250</span>
